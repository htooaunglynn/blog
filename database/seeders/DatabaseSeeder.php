...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        User::factory()->create(['name' => 'azono', 'username' => 'azono', 'email' => 'azono@gmail.com', 'password' => 'password']);
        ...
        Comment::factory(2)->create(['blog_id' => $blog1[1]->id, 'user_id' => $mgmg->id]);
        Comment::factory(2)->create(['blog_id' => $blog1[1]->id, 'user_id' => $aung->id]);
